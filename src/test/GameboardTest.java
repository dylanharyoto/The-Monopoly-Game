...
class GameboardTest {
    ...
    void testAddPlayer() {
        ...
        assertEquals(2, gameboard.getTotalPlayers());
    ...
    void testRemovePlayer() {
        assertEquals(-1, gameboard.getNextPlayerId());
        gameboard.addPlayer(player1);
        gameboard.removePlayer(player1);

        assertEquals(1, gameboard.getTotalPlayers());
    ...
    void testCheckGameStatus() {
        ...
        for (int i = 0; i < 198; i++) {
            gameboard.nextPlayer();
            System.out.println(gameboard.getRound());
        }
